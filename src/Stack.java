...
public class Stack extends java.util.Vector implements Cloneable
{
    ...
    /** |CHANGE|*/
    public Stack(int initialCap,int capacityIncrement)
    { super(initialCap, capacityIncrement);
    }
	...
	obj = peek();
        if(obj==null) return null; //|CHANGE|
	...
	if (len == 0) return null;//|CHANGE|  throw new EmptyStackException();
